...
PSoCHandler::PSoCHandler(int* file): file_i2c_(*file), mq_(MAX_QUEUE_SIZE)
{
...
void PSoCHandler::readI2C(unsigned int *buf, int length)
{
    ...
    void writeI2C(unsigned int addr, unsigned int temp = 0, unsigned int humi =0)
{
    
    unsigned int I2C_WR_Buf[10] = {0};
